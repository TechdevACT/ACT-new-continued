...
<template>
    <div class="mx-auto max-w-7xl flex-grow transition-colors duration-500 w-full">
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 ">
            <h3 class="text-md sm:text-2xl text-white">/ Industries</h3>
            <div class="sm:col-span-2 flex flex-col gap-4 sm:items-end sm:text-end text-white">
                <h3 class="text-4xl sm:text-6xl font-bold">Expertise in Various<br>
                    Industrial Fields</h3>
                <h4 class="sm:w-3/4 text-lg sm:text-xl">We are proud to have been trusted by companies from
                    various industries,
                    ranging from
                    electronics, IT, retail, manufacturing, food and beverage, skincare, insurance,
                    automotive,
                    etc.</h4>
            </div>
        </div>
