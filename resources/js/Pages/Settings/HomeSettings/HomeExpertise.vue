...
const form = useForm({
    title: props.data_fe.expertise_title || '',
    heading: props.data_fe.expertise_heading || '',
    description: props.data_fe.expertise_description || '',
});

function submit() {
    form.post(route('settings.expertiseUpdate'), {
        _method: 'patch',
        onError: (errors) => {
